...
var regexes = new Array(
  ...
  LANG_CS.expecting = "oèekávám nìco z";
  LANG_CS.unexpected_symbol = "neoèekávaný znak";
  LANG_CS.unexpected_string = "Neoèekávaný øetìzec";
  LANG_CS.was_expected = "Bylo oèekáváno nìco z";
  LANG_CS.missing = "Je¹tì oèekávám nìco z";
  LANG_CS.cont = "Mù¾ete pokraèovat v psaní";
  LANG_CS.canCont = "Mù¾ete pokraèovat nìèím z";
  LANG_CS.but_missing = ", jinak je¹tì oèekávám nìco z"; 
  LANG_CS.forLabel = " pro "; 
  LANG_CS.continueWriting = "Pokraèujte psaním";
  LANG_CS.or = " nebo ";
  LANG_CS.orInsteadOf = "Pøípadnì místo";
  LANG_CS.mustContinue = "Musíte pokraèovat psaním";
  LANG_CS.maybeWhitespace = "Mo¾ná budete muset pou¾ít bílé místo jako oddìlovaè od pøede¹lého slova.";
  LANG_CS.string = "Øetìzec";
  LANG_CS.leadsToDeadend = "vede do slepé ulièky.";
  // english language
