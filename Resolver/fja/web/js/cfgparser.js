...
{ 
  ...
  var others = new Array();
		...
		others[0].push([[[39]],   [12],   [3]]);
		others[0].push([[[44]],   [4],   [4]]);
		others[0].push([[[48, 57], [97, 109], [111, 122]],   [10,11],   [11, 5]]);
		others[0].push([[[60]],   [2],   [6]]);
		others[0].push([[[62]],   [3],   [7]]);
		others[0].push([[[65, 77], [79, 90]],   [10,9],   [11, 8]]);
		others[0].push([[[124]],   [6],   [9]]);
		others[0].push([[[45]],   [5],   [10, 14]]);
		others[0].push([[[110]],   [10,13,11],   [11, 18, 13, 15]]);
		others[0].push([[[78]],   [10,13,9],   [11, 18, 13, 16]]);
		others[0].push([[[92]],   [7],   [12, 17]]);
		others[1] = new Array();
		others[2] = new Array();
		others[3] = new Array();
		others[4] = new Array();
		others[5] = new Array();
		others[5].push([[[39]],   [10],   [11]]);
		others[6] = new Array();
		others[7] = new Array();
		others[8] = new Array();
		others[8].push([[[39]],   [10],   [11]]);
		others[9] = new Array();
		others[10] = new Array();
		others[11] = new Array();
		others[11].push([[[39]],   [10],   [11]]);
		others[12] = new Array();
		others[13] = new Array();
		others[14] = new Array();
		others[14].push([[[62]],   [5],   [10]]);
		others[15] = new Array();
		others[15].push([[[39]],   [10],   [11]]);
		others[15].push([[[65], [97]],   [13],   [13, 18]]);
		others[16] = new Array();
		others[16].push([[[39]],   [10],   [11]]);
		others[16].push([[[65], [97]],   [13],   [13, 18]]);
		others[17] = new Array();
		others[17].push([[[101]],   [7],   [12]]);
		others[18] = new Array();
		others[18].push([[[71], [103]],   [13],   [13]]);
  ...
  switch( state )
{
	case 0:
		...
		else if( (( info.src.charCodeAt( pos ) >= 48 && info.src.charCodeAt( pos ) <= 57 ) || ( info.src.charCodeAt( pos ) >= 97 && info.src.charCodeAt( pos ) <= 109 ) || ( info.src.charCodeAt( pos ) >= 111 && info.src.charCodeAt( pos ) <= 122 ) )) state = 5;
		else if( (info.src.charCodeAt( pos ) == 60 )) state = 6;
		else if( (info.src.charCodeAt( pos ) == 62 )) state = 7;
		else if( (( info.src.charCodeAt( pos ) >= 65 && info.src.charCodeAt( pos ) <= 77 ) || ( info.src.charCodeAt( pos ) >= 79 && info.src.charCodeAt( pos ) <= 90 ) )) state = 8;
		else if( (info.src.charCodeAt( pos ) == 124 )) state = 9;
		else if( (info.src.charCodeAt( pos ) == 45 )) state = 14;
	...
	case 15:
		if( (info.src.charCodeAt( pos ) == 39 )) state = 11;
		else if( (info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 )) state = 18;
		else state = -1;
   	last_state = 15;
		match = 11;
		match_pos = pos;
	...
	case 17:
		if( (info.src.charCodeAt( pos ) == 101 )) state = 12;
		else state = -1;
   	last_state = 17;
		break;
                      ...
                      var transitions_matches = findAllTransitionsMatches(source);                                                
                       ...
                       {        
                             ...
                             // now we have in matches_transitions strings in format: (regex) "tokens_regex" [TOKEN_NAME]      
                              ...
                              if(difference(expected,[26]).length) result.error_string += LANG.canCont             
                                                  +    " {" +   getExpectedLabels(difference(expected,[26])).join(", ") + "}. "
                                                  + ((isProblematicWhitespace(source))? LANG.maybeWhitespace:"");
...
parseTable[0][2] = createLL1TabEntry(false, null, [16], false, false);
parseTable[0][3] = createLL1TabEntry(false, [13, 9, 2, 10], null, false, false);
parseTable[0][4] = createLL1TabEntry(false, [13, 9, 2, 10], null, false, false);
parseTable[0][5] = createLL1TabEntry(false, [13, 9, 2, 10], null, false, false);
parseTable[0][6] = createLL1TabEntry(false, [13, 9, 2, 10], null, false, false);
parseTable[0][7] = createLL1TabEntry(false, [13, 9, 2, 10], null, false, false);
parseTable[0][8] = createLL1TabEntry(false, [13, 9, 2, 10], null, false, false);
parseTable[0][9] = createLL1TabEntry(false, null, [16], false, false);
parseTable[0][10] = createLL1TabEntry(false, null, [16], false, false);
parseTable[0][11] = createLL1TabEntry(false, [13, 9, 2, 10], null, false, false);
parseTable[0][12] = createLL1TabEntry(false, [13, 9, 2, 10], null, false, false);
parseTable[0][13] = createLL1TabEntry(false, null, [16], false, false);
parseTable[0][26] = createLL1TabEntry(false, [13, 9, 2, 10], null, false, false);
...
parseTable[2][12] = createLL1TabEntry(false, [2], null, false, false);
parseTable[2][13] = createLL1TabEntry(false, [2], null, false, false);
parseTable[2][26] = createLL1TabEntry(false, [2], null, false, false);
...
parseTable[3][12] = createLL1TabEntry(false, [3], null, false, false);
parseTable[3][13] = createLL1TabEntry(false, [3], null, false, false);
parseTable[3][26] = createLL1TabEntry(false, [3], null, false, false);
...
parseTable[4][12] = createLL1TabEntry(false, [4], null, false, false);
parseTable[4][13] = createLL1TabEntry(false, [4], null, false, false);
parseTable[4][26] = createLL1TabEntry(false, [4], null, false, false);
...
parseTable[5][12] = createLL1TabEntry(false, [5], null, false, false);
parseTable[5][13] = createLL1TabEntry(false, [5], null, false, false);
parseTable[5][26] = createLL1TabEntry(false, [5], null, false, false);
...
parseTable[6][12] = createLL1TabEntry(false, [6], null, false, false);
parseTable[6][13] = createLL1TabEntry(false, [6], null, false, false);
parseTable[6][26] = createLL1TabEntry(false, [6], null, false, false);
...
parseTable[7][12] = createLL1TabEntry(false, [7], null, false, false);
parseTable[7][13] = createLL1TabEntry(false, [7], null, false, false);
parseTable[7][26] = createLL1TabEntry(false, [7], null, false, false);
...
parseTable[8][12] = createLL1TabEntry(false, [8], null, false, false);
parseTable[8][13] = createLL1TabEntry(false, [8], null, false, false);
parseTable[8][26] = createLL1TabEntry(false, [8], null, false, false);
...
parseTable[9][12] = createLL1TabEntry(false, [9], null, false, false);
parseTable[9][13] = createLL1TabEntry(false, [9], null, false, false);
parseTable[9][26] = createLL1TabEntry(false, [9], null, false, false);
...
parseTable[10][12] = createLL1TabEntry(false, [10], null, false, false);
parseTable[10][13] = createLL1TabEntry(false, [10], null, false, false);
parseTable[10][26] = createLL1TabEntry(false, [10], null, false, false);
...
parseTable[11][12] = createLL1TabEntry(false, [11], null, false, false);
parseTable[11][13] = createLL1TabEntry(false, [11], null, false, false);
parseTable[11][26] = createLL1TabEntry(false, [11], null, false, false);
parseTable[12] = new Array();
parseTable[12][1] = createLL1TabEntry(true, null, null, false, false);
parseTable[12][2] = createLL1TabEntry(false, [12], null, false, false);
parseTable[12][3] = createLL1TabEntry(false, [12], null, false, false);
parseTable[12][4] = createLL1TabEntry(false, [12], null, false, false);
parseTable[12][5] = createLL1TabEntry(false, [12], null, false, false);
parseTable[12][6] = createLL1TabEntry(false, [12], null, false, false);
parseTable[12][7] = createLL1TabEntry(false, [12], null, false, false);
parseTable[12][8] = createLL1TabEntry(false, [12], null, false, false);
parseTable[12][9] = createLL1TabEntry(false, [12], null, false, false);
parseTable[12][10] = createLL1TabEntry(false, [12], null, false, false);
parseTable[12][11] = createLL1TabEntry(false, [12], null, false, false);
parseTable[12][12] = createLL1TabEntry(false, null, null, false, true);
parseTable[12][13] = createLL1TabEntry(false, [12], null, false, false);
parseTable[12][26] = createLL1TabEntry(false, [12], null, false, false);
...
parseTable[13][9] = createLL1TabEntry(false, [13], null, false, false);
parseTable[13][10] = createLL1TabEntry(false, [13], null, false, false);
parseTable[13][11] = createLL1TabEntry(false, [13], null, false, false);
parseTable[13][12] = createLL1TabEntry(false, [13], null, false, false);
parseTable[13][13] = createLL1TabEntry(false, null, null, false, true);
parseTable[13][26] = createLL1TabEntry(false, [13], null, false, false);
parseTable[14] = new Array();
parseTable[14][1] = createLL1TabEntry(true, null, null, false, false);
parseTable[14][2] = createLL1TabEntry(false, null, [17, 5, 18], false, false);
parseTable[14][3] = createLL1TabEntry(false, [9, 2, 10], null, false, false);
parseTable[14][4] = createLL1TabEntry(false, [9, 2, 10], null, false, false);
parseTable[14][5] = createLL1TabEntry(false, [9, 2, 10], null, false, false);
parseTable[14][6] = createLL1TabEntry(false, [9, 2, 10], null, false, false);
parseTable[14][7] = createLL1TabEntry(false, [9, 2, 10], null, false, false);
parseTable[14][8] = createLL1TabEntry(false, [9, 2, 10], null, false, false);
parseTable[14][9] = createLL1TabEntry(false, null, [17, 5, 18], false, false);
parseTable[14][10] = createLL1TabEntry(false, null, [17, 5, 18], false, false);
parseTable[14][11] = createLL1TabEntry(false, [9, 2, 10], null, false, false);
parseTable[14][12] = createLL1TabEntry(false, [9, 2, 10], null, false, false);
parseTable[14][13] = createLL1TabEntry(false, [9, 2, 10], null, false, false);
parseTable[14][26] = createLL1TabEntry(false, [9, 2, 10], null, false, false);
parseTable[15] = new Array();
parseTable[15][1] = createLL1TabEntry(true, null, null, false, false);
parseTable[15][2] = createLL1TabEntry(false, [4, 8, 26], null, false, false);
parseTable[15][3] = createLL1TabEntry(false, [4, 8, 26], null, false, false);
parseTable[15][4] = createLL1TabEntry(false, null, [22, 14, 15], false, false);
parseTable[15][5] = createLL1TabEntry(false, [4, 8, 26], null, false, false);
parseTable[15][6] = createLL1TabEntry(false, [4, 8, 26], null, false, false);
parseTable[15][7] = createLL1TabEntry(false, [4, 8, 26], null, false, false);
parseTable[15][8] = createLL1TabEntry(false, null, [22, 14, 15], false, false);
parseTable[15][9] = createLL1TabEntry(false, [4, 8, 26], null, false, false);
parseTable[15][10] = createLL1TabEntry(false, [4, 8, 26], null, false, false);
parseTable[15][11] = createLL1TabEntry(false, [4, 8, 26], null, false, false);
parseTable[15][12] = createLL1TabEntry(false, [4, 8, 26], null, false, false);
parseTable[15][13] = createLL1TabEntry(false, [4, 8, 26], null, false, false);
parseTable[15][26] = createLL1TabEntry(false, null, [], false, false);
parseTable[16] = new Array();
parseTable[16][1] = createLL1TabEntry(true, null, null, false, false);
parseTable[16][2] = createLL1TabEntry(false, null, [14, 15], false, false);
parseTable[16][3] = createLL1TabEntry(false, [9, 2, 10, 13], null, false, false);
parseTable[16][4] = createLL1TabEntry(false, [9, 2, 10, 13], null, false, false);
parseTable[16][5] = createLL1TabEntry(false, [9, 2, 10, 13], null, false, false);
parseTable[16][6] = createLL1TabEntry(false, [9, 2, 10, 13], null, false, false);
parseTable[16][7] = createLL1TabEntry(false, [9, 2, 10, 13], null, false, false);
parseTable[16][8] = createLL1TabEntry(false, [9, 2, 10, 13], null, false, false);
parseTable[16][9] = createLL1TabEntry(false, null, [14, 15], false, false);
parseTable[16][10] = createLL1TabEntry(false, null, [14, 15], false, false);
parseTable[16][11] = createLL1TabEntry(false, [9, 2, 10, 13], null, false, false);
parseTable[16][12] = createLL1TabEntry(false, [9, 2, 10, 13], null, false, false);
parseTable[16][13] = createLL1TabEntry(false, null, [13], false, false);
parseTable[16][26] = createLL1TabEntry(false, [9, 2, 10, 13], null, false, false);
parseTable[17] = new Array();
parseTable[17][1] = createLL1TabEntry(true, null, null, false, false);
parseTable[17][2] = createLL1TabEntry(false, null, [2, 23, 3], false, false);
parseTable[17][3] = createLL1TabEntry(false, [9, 2, 10], null, false, false);
parseTable[17][4] = createLL1TabEntry(false, [9, 2, 10], null, false, false);
parseTable[17][5] = createLL1TabEntry(false, [9, 2, 10], null, false, false);
parseTable[17][6] = createLL1TabEntry(false, [9, 2, 10], null, false, false);
parseTable[17][7] = createLL1TabEntry(false, [9, 2, 10], null, false, false);
parseTable[17][8] = createLL1TabEntry(false, [9, 2, 10], null, false, false);
parseTable[17][9] = createLL1TabEntry(false, null, [9], false, false);
parseTable[17][10] = createLL1TabEntry(false, null, [10], false, false);
parseTable[17][11] = createLL1TabEntry(false, [9, 2, 10], null, false, false);
parseTable[17][12] = createLL1TabEntry(false, [9, 2, 10], null, false, false);
parseTable[17][13] = createLL1TabEntry(false, [9, 2, 10], null, false, false);
parseTable[17][26] = createLL1TabEntry(false, [9, 2, 10], null, false, false);
parseTable[18] = new Array();
parseTable[18][1] = createLL1TabEntry(true, null, null, false, false);
parseTable[18][2] = createLL1TabEntry(false, null, [19, 25], false, false);
parseTable[18][3] = createLL1TabEntry(false, [7, 9, 2, 10, 11], null, false, false);
parseTable[18][4] = createLL1TabEntry(false, [7, 9, 2, 10, 11], null, false, false);
parseTable[18][5] = createLL1TabEntry(false, [7, 9, 2, 10, 11], null, false, false);
parseTable[18][6] = createLL1TabEntry(false, [7, 9, 2, 10, 11], null, false, false);
parseTable[18][7] = createLL1TabEntry(false, null, [19, 25], false, false);
parseTable[18][8] = createLL1TabEntry(false, [7, 9, 2, 10, 11], null, false, false);
parseTable[18][9] = createLL1TabEntry(false, null, [19, 25], false, false);
parseTable[18][10] = createLL1TabEntry(false, null, [19, 25], false, false);
parseTable[18][11] = createLL1TabEntry(false, null, [19, 25], false, false);
parseTable[18][12] = createLL1TabEntry(false, [7, 9, 2, 10, 11], null, false, false);
parseTable[18][13] = createLL1TabEntry(false, [7, 9, 2, 10, 11], null, false, false);
parseTable[18][26] = createLL1TabEntry(false, [7, 9, 2, 10, 11], null, false, false);
parseTable[19] = new Array();
parseTable[19][1] = createLL1TabEntry(true, null, null, false, false);
parseTable[19][2] = createLL1TabEntry(false, null, [17, 20], false, false);
parseTable[19][3] = createLL1TabEntry(false, [9, 2, 10, 11, 7], null, false, false);
parseTable[19][4] = createLL1TabEntry(false, [9, 2, 10, 11, 7], null, false, false);
parseTable[19][5] = createLL1TabEntry(false, [9, 2, 10, 11, 7], null, false, false);
parseTable[19][6] = createLL1TabEntry(false, [9, 2, 10, 11, 7], null, false, false);
parseTable[19][7] = createLL1TabEntry(false, null, [7], false, false);
parseTable[19][8] = createLL1TabEntry(false, [9, 2, 10, 11, 7], null, false, false);
parseTable[19][9] = createLL1TabEntry(false, null, [17, 20], false, false);
parseTable[19][10] = createLL1TabEntry(false, null, [17, 20], false, false);
parseTable[19][11] = createLL1TabEntry(false, null, [21, 20], false, false);
parseTable[19][12] = createLL1TabEntry(false, [9, 2, 10, 11, 7], null, false, false);
parseTable[19][13] = createLL1TabEntry(false, [9, 2, 10, 11, 7], null, false, false);
parseTable[19][26] = createLL1TabEntry(false, [9, 2, 10, 11, 7], null, false, false);
parseTable[20] = new Array();
parseTable[20][1] = createLL1TabEntry(true, null, null, false, false);
parseTable[20][2] = createLL1TabEntry(false, null, [17, 20], false, false);
parseTable[20][3] = createLL1TabEntry(false, [9, 2, 10, 11, 26, 4, 8, 6], null, false, false);
parseTable[20][4] = createLL1TabEntry(false, null, [], false, false);
parseTable[20][5] = createLL1TabEntry(false, [9, 2, 10, 11, 26, 4, 8, 6], null, false, false);
parseTable[20][6] = createLL1TabEntry(false, null, [], false, false);
parseTable[20][7] = createLL1TabEntry(false, [9, 2, 10, 11, 26, 4, 8, 6], null, false, false);
parseTable[20][8] = createLL1TabEntry(false, null, [], false, false);
parseTable[20][9] = createLL1TabEntry(false, null, [17, 20], false, false);
parseTable[20][10] = createLL1TabEntry(false, null, [17, 20], false, false);
parseTable[20][11] = createLL1TabEntry(false, null, [21, 20], false, false);
parseTable[20][12] = createLL1TabEntry(false, [9, 2, 10, 11, 26, 4, 8, 6], null, false, false);
parseTable[20][13] = createLL1TabEntry(false, [9, 2, 10, 11, 26, 4, 8, 6], null, false, false);
parseTable[20][26] = createLL1TabEntry(false, null, [], false, false);
parseTable[21] = new Array();
parseTable[21][1] = createLL1TabEntry(true, null, null, false, false);
parseTable[21][2] = createLL1TabEntry(false, [11], null, false, false);
parseTable[21][3] = createLL1TabEntry(false, [11], null, false, false);
parseTable[21][4] = createLL1TabEntry(false, [11], null, false, false);
parseTable[21][5] = createLL1TabEntry(false, [11], null, false, false);
parseTable[21][6] = createLL1TabEntry(false, [11], null, false, false);
parseTable[21][7] = createLL1TabEntry(false, [11], null, false, false);
parseTable[21][8] = createLL1TabEntry(false, [11], null, false, false);
parseTable[21][9] = createLL1TabEntry(false, [11], null, false, false);
parseTable[21][10] = createLL1TabEntry(false, [11], null, false, false);
parseTable[21][11] = createLL1TabEntry(false, null, [11], false, false);
parseTable[21][12] = createLL1TabEntry(false, [11], null, false, false);
parseTable[21][13] = createLL1TabEntry(false, [11], null, false, false);
parseTable[21][26] = createLL1TabEntry(false, [11], null, false, false);
parseTable[22] = new Array();
parseTable[22][1] = createLL1TabEntry(true, null, null, false, false);
parseTable[22][2] = createLL1TabEntry(false, [4, 8], null, false, false);
parseTable[22][3] = createLL1TabEntry(false, [4, 8], null, false, false);
parseTable[22][4] = createLL1TabEntry(false, null, [4, 8], false, false);
parseTable[22][5] = createLL1TabEntry(false, [4, 8], null, false, false);
parseTable[22][6] = createLL1TabEntry(false, [4, 8], null, false, false);
parseTable[22][7] = createLL1TabEntry(false, [4, 8], null, false, false);
parseTable[22][8] = createLL1TabEntry(false, null, [8], false, false);
parseTable[22][9] = createLL1TabEntry(false, [4, 8], null, false, false);
parseTable[22][10] = createLL1TabEntry(false, [4, 8], null, false, false);
parseTable[22][11] = createLL1TabEntry(false, [4, 8], null, false, false);
parseTable[22][12] = createLL1TabEntry(false, [4, 8], null, false, false);
parseTable[22][13] = createLL1TabEntry(false, [4, 8], null, false, false);
parseTable[22][26] = createLL1TabEntry(false, [4, 8], null, false, false);
parseTable[23] = new Array();
parseTable[23][1] = createLL1TabEntry(true, null, null, false, false);
parseTable[23][2] = createLL1TabEntry(false, [9, 11, 10], null, false, false);
parseTable[23][3] = createLL1TabEntry(false, [9, 11, 10], null, false, false);
parseTable[23][4] = createLL1TabEntry(false, [9, 11, 10], null, false, false);
parseTable[23][5] = createLL1TabEntry(false, [9, 11, 10], null, false, false);
parseTable[23][6] = createLL1TabEntry(false, [9, 11, 10], null, false, false);
parseTable[23][7] = createLL1TabEntry(false, [9, 11, 10], null, false, false);
parseTable[23][8] = createLL1TabEntry(false, [9, 11, 10], null, false, false);
parseTable[23][9] = createLL1TabEntry(false, null, [9, 24], false, false);
parseTable[23][10] = createLL1TabEntry(false, null, [10, 24], false, false);
parseTable[23][11] = createLL1TabEntry(false, null, [11, 24], false, false);
parseTable[23][12] = createLL1TabEntry(false, [9, 11, 10], null, false, false);
parseTable[23][13] = createLL1TabEntry(false, [9, 11, 10], null, false, false);
parseTable[23][26] = createLL1TabEntry(false, [9, 11, 10], null, false, false);
parseTable[24] = new Array();
parseTable[24][1] = createLL1TabEntry(true, null, null, false, false);
parseTable[24][2] = createLL1TabEntry(false, [9, 11, 10, 3], null, false, false);
parseTable[24][3] = createLL1TabEntry(false, null, [], false, false);
parseTable[24][4] = createLL1TabEntry(false, [9, 11, 10, 3], null, false, false);
parseTable[24][5] = createLL1TabEntry(false, [9, 11, 10, 3], null, false, false);
parseTable[24][6] = createLL1TabEntry(false, [9, 11, 10, 3], null, false, false);
parseTable[24][7] = createLL1TabEntry(false, [9, 11, 10, 3], null, false, false);
parseTable[24][8] = createLL1TabEntry(false, [9, 11, 10, 3], null, false, false);
parseTable[24][9] = createLL1TabEntry(false, null, [9, 24], false, false);
parseTable[24][10] = createLL1TabEntry(false, null, [10, 24], false, false);
parseTable[24][11] = createLL1TabEntry(false, null, [11, 24], false, false);
parseTable[24][12] = createLL1TabEntry(false, [9, 11, 10, 3], null, false, false);
parseTable[24][13] = createLL1TabEntry(false, [9, 11, 10, 3], null, false, false);
parseTable[24][26] = createLL1TabEntry(false, [9, 11, 10, 3], null, false, false);
parseTable[25] = new Array();
parseTable[25][1] = createLL1TabEntry(true, null, null, false, false);
parseTable[25][2] = createLL1TabEntry(false, [6, 26, 4, 8], null, false, false);
parseTable[25][3] = createLL1TabEntry(false, [6, 26, 4, 8], null, false, false);
parseTable[25][4] = createLL1TabEntry(false, null, [], false, false);
parseTable[25][5] = createLL1TabEntry(false, [6, 26, 4, 8], null, false, false);
parseTable[25][6] = createLL1TabEntry(false, null, [6, 19, 25], false, false);
parseTable[25][7] = createLL1TabEntry(false, [6, 26, 4, 8], null, false, false);
parseTable[25][8] = createLL1TabEntry(false, null, [], false, false);
parseTable[25][9] = createLL1TabEntry(false, [6, 26, 4, 8], null, false, false);
parseTable[25][10] = createLL1TabEntry(false, [6, 26, 4, 8], null, false, false);
parseTable[25][11] = createLL1TabEntry(false, [6, 26, 4, 8], null, false, false);
parseTable[25][12] = createLL1TabEntry(false, [6, 26, 4, 8], null, false, false);
parseTable[25][13] = createLL1TabEntry(false, [6, 26, 4, 8], null, false, false);
parseTable[25][26] = createLL1TabEntry(false, null, [], false, false);
parseTable[26] = new Array();
parseTable[26][1] = createLL1TabEntry(true, null, null, false, false);
parseTable[26][2] = createLL1TabEntry(false, [26], null, false, false);
parseTable[26][3] = createLL1TabEntry(false, [26], null, false, false);
parseTable[26][4] = createLL1TabEntry(false, [26], null, false, false);
parseTable[26][5] = createLL1TabEntry(false, [26], null, false, false);
parseTable[26][6] = createLL1TabEntry(false, [26], null, false, false);
parseTable[26][7] = createLL1TabEntry(false, [26], null, false, false);
parseTable[26][8] = createLL1TabEntry(false, [26], null, false, false);
parseTable[26][9] = createLL1TabEntry(false, [26], null, false, false);
parseTable[26][10] = createLL1TabEntry(false, [26], null, false, false);
parseTable[26][11] = createLL1TabEntry(false, [26], null, false, false);
parseTable[26][12] = createLL1TabEntry(false, [26], null, false, false);
parseTable[26][13] = createLL1TabEntry(false, [26], null, false, false);
parseTable[26][26] = createLL1TabEntry(false, null, null, true, false);
...
var labels = new Array(
	...
	"NEW_LINE" /* Terminal symbol */,
	"BIG_LETTER" /* Terminal symbol */,
	"SYMBOL_WITH_APOSTROPHE" /* Terminal symbol */,
	"SMALL_LETTER_OR_NUM" /* Terminal symbol */,
	"APOSTROF" /* Terminal symbol */,
	"NAG" /* Terminal symbol */,
	"Rule" /* Non-terminal symbol */,
	"Rule2" /* Non-terminal symbol */,
	"Start" /* Non-terminal symbol */,
	"Nonterminal" /* Non-terminal symbol */,
	"RuleRhs" /* Non-terminal symbol */,
	"RuleRhsItem" /* Non-terminal symbol */,
	"End" /* Non-terminal symbol */,
	"Terminal" /* Non-terminal symbol */,
	"Separator" /* Non-terminal symbol */,
	"String" /* Non-terminal symbol */,
	"StringCont" /* Non-terminal symbol */,
	"RuleRhs*" /* Non-terminal symbol */,
	"EOF" /* Terminal symbol */
);
...
var regexes = new Array(
	...
	unescape("%5Ba-zA-Z0-9%5D%5B%5C%27%5D+") /* Terminal symbol */,
	unescape("%5Ba-z0-9%5D") /* Terminal symbol */,
	unescape("%5C%27") /* Terminal symbol */,
	unescape("%5BnN%5D%5BaA%5D%5BgG%5D") /* Terminal symbol */,
	unescape("undefined") /* Non-terminal symbol */,
	unescape("undefined") /* Non-terminal symbol */,
	unescape("undefined") /* Non-terminal symbol */,
	unescape("undefined") /* Non-terminal symbol */,
