...
public class Login extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            String to = "admin.jsp";
            if (request.getParameter("from") != null) to = request.getParameter("from");
            AuthMethod auth = new PamAuth();
            boolean logged = auth.login(request.getParameter("username"), request.getParameter("password"));
